      ...
      <div className="flex navbar-end gap-x-2">
        ...
        <details className="dropdown dropdown-end">
          <summary
            ...
            className={`z-50 p-2 mr-2 border-2 btn btn-square rounded-none btn-outline bg-[#54595f] ${
              navToggle ? "border-none" : "border-none"
            } lg:hidden`}
          >
            {navToggle ? (
              <svg
              ...
              <svg
                ...
                fill="none"
                viewBox="0 0 24 24"
                className="inline-block w-6 h-6 text-2xl text-white stroke-current swap-off"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 z-[100] p-2 shadow bg-[#B5E1F6] rounded-box w-52 animate-flip-down font-bold gap-2 border-2 border-primary divide-y-2 divide-primary"
          >
            {links}
